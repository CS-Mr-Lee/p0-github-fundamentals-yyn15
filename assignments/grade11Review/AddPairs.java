...
public class AddPairs
{
   public static void main (String [] args)
   {
      ...
      if(fullNum.length()%2 !=0){
         ...
         length = length + 1;
         nums = new int[length];
         nums[length-1] = Integer.parseInt(fullNum.substring(fullNum.length()-1));  //if the integer is odd, then the last digit will not form a pair
      ...
      //put the integer into pairs in an array
